...
export function validatePreferences(value) {
  ...
  for (const key of ['listen', 'hint', 'wait', 'autoContinue', 'checkLines', 'build']) if (value[key] !== undefined && typeof value[key] !== 'boolean') throw fail('Invalid project rehearsal settings.');
